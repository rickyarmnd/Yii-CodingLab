...
use admin\models\TesPjaxSearch;
...
/**
 * TesPjaxController implements the CRUD actions for Guru model.
 */
class TesPjaxController extends Controller
{
    /**
     * @inheritdoc
     */
