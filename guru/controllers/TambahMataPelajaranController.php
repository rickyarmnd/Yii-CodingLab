...
use guru\models\TambahMataPelajaranSearch;
...
/**
 * TambahMataPelajaranController implements the CRUD actions for MataPelajaran model.
 */
class TambahMataPelajaranController extends Controller
{
    ...
    {    
        $searchModel = new TambahMataPelajaranSearch();
